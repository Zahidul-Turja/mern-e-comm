...
function AnalyticsTab() {
  ...
  if (isLoading) {
    return (
      <div className="flex min-h-72 items-center justify-center bg-transparent">
        <div className="relative">
          <div className="h-20 w-20 rounded-full border-2 border-emerald-200" />
          <div className="absolute left-0 top-0 h-20 w-20 animate-spin rounded-full border-t-2 border-emerald-500" />
